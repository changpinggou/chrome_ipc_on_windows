...
//   if (base::IsLaunchFromeExplorerProc()){
//     const std::wstring::size_type space_pos = command_line.find_first_of(L" ", 0);
//     if (space_pos != std::wstring::npos){
//       command_line = command_line.substr(0, space_pos);
//     }
//   }
	current_process_commandline_->ParseFromString(command_line);
#elif defined(OS_POSIX)
