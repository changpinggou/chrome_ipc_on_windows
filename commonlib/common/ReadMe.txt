========================================================================
    ACTIVE TEMPLATE LIBRARY : common Project Overview
========================================================================

AppWizard has created this common project for you to use as the starting point for
...
common.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (common.h)
        GUID definitions                                (common_i.c)
        A type library                                  (common.tlb)
        Marshaling code                                 (common_p.c and dlldata.c)

common.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in common.idl. It will be regenerated by MIDL during compilation.
...
commonps.vcxproj
	...
	dlldata.c, common_i.c and common_p.c which are required
	to build the proxy/stub DLL.

commonps.vcxproj.filters
